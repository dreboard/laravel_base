	...
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			<li class="sidebar-search">
				<form class="form-inline" method="post" action="{{route('searching')}}">
					{{csrf_field()}}
			...
			<li>
				...
				<ul class="nav nav-second-level">
					<li>
						<a href="{{ route('home') }}">Panels and Wells</a>
					</li>
					<li>
						<a href="{{ route('home') }}">Buttons</a>
					</li>
					<li>
						<a href="{{ route('home') }}">Notifications</a>
					</li>
					<li>
						<a href="{{ route('home') }}">Typography</a>
					</li>
					<li>
						<a href="{{ route('home') }}"> Icons</a>
					</li>
					<li>
